    ...
    <div class="container">
      ...
      <div class="row copyright">
        <div class="col-sm-12 text-muted">
          Copyright <sup>&copy;</sup> {{ currentYear }} MarkLogic Corporation. MARKLOGIC <sup>&reg;</sup> is a registered trademark of MarkLogic Corporation.
        </div>
      </div>
    </div>
  </footer>
